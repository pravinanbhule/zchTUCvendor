...
function AddEditForm(props) {
    ...
    if (selectedlanguage?.value) {
      ...
      if (IncountryFlag === IncountryFlagConst.GERMANY) {
        if (selectedlanguage.value === "DE001") {
          formdomfields.filter((item) =>
            item.name === "RequestForEmpowermentReason"
              ...
              ? (item.titlelinespace = false)
              : item.name === "AccountNumber" && accountNumberShow
              ? (item.colspan = 3)
        ...
        if (
          ...
          formdomfields.filter((item) =>
            item.name === "ReferralReasonLevel2"
              ? ((item.isAddButton = true), (item.colspan = 3))
              : item.name === "ReferralReasonLevel3"
              ? (item.colspan = 0)
              : item.name === "AccountNumber" && accountNumberShow
              ? (item.colspan = 3)
        ...
        if (
          formfield.RequestForEmpowermentReason !== "" &&
          formfield.RequestForEmpowermentReason !== null
        ) {
  ...
  const handleMultiDropdown = (value, name) => {
    if (name === "RequestForEmpowermentReason") {
      ...
      let GermanyReasonOption = GermanyOptions.filter(
        (item) =>
      ...
      let GermanyReasonOption1 = GermanyOptions.filter(
        (item) =>
          item.label.toLowerCase().replace(/\s/g, "") !== reasonOtherValue &&
          item.value !== formfield.RequestForEmpowermentReason &&
  ...
  const handleSelectChange = (name, value, fieldName, label) => {
    ...
    if (name === "LOBId") {
      ...
      SelectedLabel === reasonOtherValue
    ) {
      setShowTextBox(true);
      setShowButtons(false);
      setReasonfields({
  ...
  const [paginationdata, setpaginationdata] = useState([
    {
        "rfeLogId": "RFE01370386795B48B38DD05ECC093CD119",
        "accountName": "Test Email",
        "entryNumber": "RFE_14647384",
        "organizationalAlignment": "BF101521-5244-496B-AAC6-A50FDBDC92A4",
        "countryId": "AC930B0B-D503-4857-9A1D-463425EA9875",
        "regionId": "REG00005",
        "underwriter": "PattiF@2k0hmr.onmicrosoft.com",
        "chz": null,
        "lobId": "441599652353885",
        "requestForEmpowermentReason": "E234F097-4B52-4323-9B71-843D8CAFE04A",
        "rfeLogDetails": "<p>Test</p>",
        "underwriterGrantingEmpowerment": "MiriamG@2k0hmr.onmicrosoft.com,MeganB@2k0hmr.onmicrosoft.com,janine.loh@dlazuredelphianlogic116.onmicrosoft.com",
        "requestForEmpowermentCC": null,
        "requestForEmpowermentStatus": "FA04DC3E-028E-43FB-820A-B8FAFE7E44F9",
        "responseDate": null,
        "receptionInformationDate": null,
        "underwriterGrantingEmpowermentComments": null,
        "isActive": true,
        "isSubmit": true,
        "createdById": "USR_7rUXlWDh",
        "createdDate": "2023-06-22T10:11:03.54",
        "modifiedById": "USR_7rUXlWDh",
        "modifiedDate": "2023-10-27T07:48:38.95",
        "lobName": "Commercial Property",
        "countryName": "United States",
        "regionName": "ZNA",
        "chzValue": null,
        "organizationalAlignmentValue": "Global",
        "requestForEmpowermentReasonValue": "Captive",
        "requestForEmpowermentStatusValue": "Empowerment Not Granted",
        "creatorName": "Patti Fernandez",
        "underwriterName": "Patti Fernandez",
        "underwriterGrantingEmpowermentName": null,
        "requestForEmpowermentCCName": null,
        "roleData": null,
        "rfeLogEmailLink": "https://dlzchui.azurewebsites.net/rfelogs?id=RFE01370386795B48B38DD05ECC093CD119",
        "totalCount": 0,
        "isArchived": false,
        "globalRFELogURL": null,
        "lastModifiorName": "Patti Fernandez",
        "sourceItemId": null,
        "isSharepointArchived": false,
        "importedBy": "",
        "importedDate": "2023-06-22T10:11:03.54",
        "conditionApplicableTo": null,
        "conditionApplicableToValue": null,
        "durationofApproval": "547V7D10-3334-064H-N831-H225743690RD",
        "durationofApprovalValue": "1",
        "branch": null,
        "customerSegment": null,
        "newRenewal": null,
        "policyPeriod": null,
        ...
        "newRenewalValue": null,
        "currencyValue": null,
        "decisionDate": null,
        "referralType": null,
        "referralTypeName": null,
        "referralLevelGC": null,
        "duns": null,
        "customerSegmentGC": null,
        "title": null,
        "lineofBusinessPortfolio": null,
        "referralReasonLevel1": null,
        "referralReasonLevel1Name": null,
        "referralReasonLevel2": null,
        "referralReasonLevel2Name": null,
        "referralReasonLevel3": null,
        "referralReasonActuarialLevel1": null,
        "referralReasonActuarialLevel2": null,
        "approvedPricingTool": null,
        ...
        "corporateResponsibility": null,
        "corporateResponsibilityName": null,
        "cRiBTOutcome": null,
        "contractTerm": null,
        "effectiveDate": null,
        "zurichRateChange": null,
        "attachmentPoint": null,
        "deductible": null,
        "submissionDate": null,
        "targetDate": null,
        "referralStatusUW": null,
        "decisionDateUW": null,
        "referralActuary": null,
        "referralStatusActuarial": null,
        "decisionDateActuarial": null,
        "attachment": null,
        "italyGILocalReferralLog": null,
        "lineofBusinessItalyReferralLog": null,
        "policyNumber": null,
        "quraNumber": null,
        "referralComments": null,
        "referralReasonItalyReferralLog": null,
        ...
        "mailboxName": null,
        "otherReferralReason": null,
        "requiredSignOffAuthority": null,
        "submitterAuthority": null,
        "submitterAuthorityName": null,
        "freedomofServices": null,
        "freedomofServicesName": null,
        "businessArea": null,
        "businessAreaName": null,
        "policy": null,
        "incountryFlag": null,
        "sublobid": "111602148297538",
        "sublobName": "Restricted covers & exposures",
        "accountNumber": null,
        "linkedRFEEntryNumber": null
    },
    {
        "rfeLogId": "RFE0154BAB383244AC5AE8A05BBEAA26339",
        "accountName": "Test",
        "entryNumber": "RFE_25647584",
        "organizationalAlignment": "A6B6A43F-574E-4E15-9EC2-49D080A16C45",
        "countryId": "COU000028",
        "regionId": "REG00001",
        "underwriter": "PattiF@2k0hmr.onmicrosoft.com",
        "chz": null,
        "lobId": "441599652036479",
        "requestForEmpowermentReason": "GEN1735104D-92E6-4688-90EF-9D53A316A866",
        "rfeLogDetails": "<p>Test</p>",
        "underwriterGrantingEmpowerment": "GradyA@2k0hmr.onmicrosoft.com",
        "requestForEmpowermentCC": null,
        "requestForEmpowermentStatus": "8BC958F0-677E-43AD-9886-D719082D21BD",
        "responseDate": null,
        "receptionInformationDate": null,
        "underwriterGrantingEmpowermentComments": null,
        "isActive": true,
        "isSubmit": true,
        "createdById": "USR_7rUXlWDh",
        "createdDate": "2023-12-04T07:48:16.343",
        "modifiedById": "USR_7rUXlWDh",
        "modifiedDate": "2023-12-04T09:43:23.16",
        "lobName": "Accident and Health",
        "countryName": "Singapore",
        "regionName": "APAC",
        "chzValue": null,
        "organizationalAlignmentValue": "Country",
        "requestForEmpowermentReasonValue": "New Underwriter - No LoA",
        "requestForEmpowermentStatusValue": "Pending",
        "creatorName": "Patti Fernandez",
        "underwriterName": "Patti Fernandez",
        "underwriterGrantingEmpowermentName": null,
        "requestForEmpowermentCCName": null,
        "roleData": null,
        "rfeLogEmailLink": "https://dlzchui.azurewebsites.net/rfelogs?id=RFE0154BAB383244AC5AE8A05BBEAA26339",
        "totalCount": 0,
        "isArchived": false,
        "globalRFELogURL": null,
        "lastModifiorName": "Patti Fernandez",
        ...
        "isSharepointArchived": false,
        "importedBy": "",
        "importedDate": "2023-12-04T07:48:16.343",
        "conditionApplicableTo": null,
        "conditionApplicableToValue": null,
        "durationofApproval": "547V7D10-3334-064H-N831-H225743690RD",
        "durationofApprovalValue": "1",
    ...
    {
        "rfeLogId": "RFE04FD2C303E34484ABBA130DDB9A79A8C",
        "accountName": "Test1258",
        "entryNumber": "RFE_77718094",
        "organizationalAlignment": "A6B6A43F-574E-4E15-9EC2-49D080A16C45",
        "countryId": "COU000013",
        "regionId": "REG00002",
        "underwriter": "PattiF@2k0hmr.onmicrosoft.com",
        "chz": null,
        "lobId": "441599652036479",
        "requestForEmpowermentReason": "79E5FF0B-CB9E-4050-965F-85A1756C771A",
        "rfeLogDetails": "<p>Testing</p>",
        "underwriterGrantingEmpowerment": "GradyA@2k0hmr.onmicrosoft.com",
        "requestForEmpowermentCC": null,
        "requestForEmpowermentStatus": "244A22AD-A1E3-409E-BB77-A0C069AD377A",
        "responseDate": null,
        "receptionInformationDate": null,
        "underwriterGrantingEmpowermentComments": null,
        "isActive": true,
        "isSubmit": true,
        "createdById": "USR_7rUXlWDh",
        "createdDate": "2024-05-21T08:45:08.07",
        "modifiedById": "USR_7rUXlWDh",
        "modifiedDate": "2024-05-27T06:03:23.577",
        "lobName": "Accident and Health",
        "countryName": "Germany",
        "regionName": "EMEA",
        "chzValue": null,
        "organizationalAlignmentValue": "Country",
        "requestForEmpowermentReasonValue": "Commissions",
        "requestForEmpowermentStatusValue": "More Information Needed",
        "creatorName": "Patti Fernandez",
        "underwriterName": "Patti Fernandez",
        "underwriterGrantingEmpowermentName": null,
        "requestForEmpowermentCCName": null,
        "roleData": null,
        "rfeLogEmailLink": "https://dlzchui.azurewebsites.net/rfelogs?id=RFE04FD2C303E34484ABBA130DDB9A79A8C",
        "totalCount": 0,
        "isArchived": false,
        "globalRFELogURL": null,
        "lastModifiorName": "Patti Fernandez",
        ...
        "isSharepointArchived": false,
        "importedBy": "",
        "importedDate": "2024-05-21T08:45:08.07",
        "conditionApplicableTo": null,
        "conditionApplicableToValue": null,
        "durationofApproval": "547V7D10-3334-064H-N831-H225743690RD",
        "durationofApprovalValue": "1",
        "branch": null,
        "customerSegment": "2AD1D87F-EA41-48F7-98D4-0429EA9C0937",
        "newRenewal": "1AF88858-EB03-46B4-8ADF-581B3A1337E7",
        "policyPeriod": null,
        "currency": null,
        "limit": null,
        "gwp": "12",
        "zurichShare": "125",
        "branchValue": null,
        "customerSegmentValue": "Corporate",
        "newRenewalValue": "New",
        "currencyValue": null,
        "decisionDate": null,
        "referralType": null,
        ...
        "policy": null,
        "incountryFlag": "DE001",
        "sublobid": "951599652050396",
        "sublobName": "Health",
        "accountNumber": null,
        "linkedRFEEntryNumber": null
    },
    {
        "rfeLogId": "RFE00C12F411D004BB89E1DDEB777C55B43",
        "accountName": "Policy 360 API 21_0_2023",
        "entryNumber": "RFE_80164758",
        "organizationalAlignment": "BF101521-5244-496B-AAC6-A50FDBDC92A4",
        "countryId": "COU000001",
        "regionId": "REG00003",
        "underwriter": "PattiF@2k0hmr.onmicrosoft.com",
        "chz": null,
        "lobId": "821602153704541",
        "requestForEmpowermentReason": "E234F097-4B52-4323-9B71-843D8CAFE04A",
        "rfeLogDetails": "<p>Testing Log data.</p>",
        "underwriterGrantingEmpowerment": "GradyA@2k0hmr.onmicrosoft.com,MeganB@2k0hmr.onmicrosoft.com",
        "requestForEmpowermentCC": "MeganB@2k0hmr.onmicrosoft.com",
        "requestForEmpowermentStatus": "8BC958F0-677E-43AD-9886-D719082D21BD",
        "responseDate": "2023-05-11T00:00:00",
        "receptionInformationDate": "2023-05-11T00:00:00",
        "underwriterGrantingEmpowermentComments": "Testing Comments",
        "isActive": true,
        "isSubmit": true,
        "createdById": "USR_7rUXlWDh",
        "createdDate": "2023-06-21T10:47:48.307",
        "modifiedById": "USR_dw12esIh",
        "modifiedDate": "2023-11-15T06:48:31.733",
        "lobName": "Property Coverages and Extensions",
        ...
        "underwriterName": "Patti Fernandez",
        "underwriterGrantingEmpowermentName": null,
        "requestForEmpowermentCCName": "MeganBowen'",
        "roleData": null,
        "rfeLogEmailLink": "https://dlzchui.azurewebsites.net/rfelogs?id=RFE00C12F411D004BB89E1DDEB777C55B43",
        "totalCount": 0,
        "isArchived": false,
        "globalRFELogURL": null,
        "lastModifiorName": "Megan Bowen",
        "sourceItemId": null,
        "isSharepointArchived": false,
        "importedBy": "",
        "importedDate": "2023-06-21T10:47:48.307",
        "conditionApplicableTo": null,
        "conditionApplicableToValue": null,
        "durationofApproval": "447E0U07-2022-703I-A457-A024513620IK",
        "durationofApprovalValue": "3",
        "branch": null,
        "customerSegment": null,
        "newRenewal": null,
        "policyPeriod": null,
        ...
        "sublobName": "Restricted covers & exposures",
        "accountNumber": null,
        "linkedRFEEntryNumber": "RFE_25647584,RFE_14647384"
    },
    {
        "rfeLogId": "RFE01CA6EF08A3141499A6C8820A6B34E09",
        "accountName": "Test693",
        "entryNumber": "RFE_82852923",
        "organizationalAlignment": "BF101521-5244-496B-AAC6-A50FDBDC92A4",
        "countryId": "COU000001,COU000002,COU000003,COU951B03DFC0874829A3A8D5136EE1CEFD,COUC924407329854C90B61ABBE5E253E19B,COUD5E3A24443884A5CA4FF2587392AB6E0,COU000004,COU000005",
        "regionId": null,
        "underwriter": "MeganB@2k0hmr.onmicrosoft.com",
        "chz": "BFF60D82-B697-44EE-BE56-0069727D88E3",
        "lobId": "441599652036479",
        "requestForEmpowermentReason": "E234F097-4B52-4323-9B71-843D8CAFE04A",
        "rfeLogDetails": "<p>Testing</p>",
        "underwriterGrantingEmpowerment": "PattiF@2k0hmr.onmicrosoft.com",
        "requestForEmpowermentCC": null,
        "requestForEmpowermentStatus": "8BC958F0-677E-43AD-9886-D719082D21BD",
        "responseDate": null,
        "receptionInformationDate": null,
        ...
        "isSubmit": true,
        "createdById": "USR_7rUXlWDh",
        "createdDate": "2023-11-22T12:19:48.98",
        "modifiedById": "USR_7rUXlWDh",
        "modifiedDate": "2023-11-23T04:47:51.48",
        "lobName": "Accident and Health",
        "countryName": "Argentina,Australia,Austria,Benelux All Countries,Brazil,Benelux - Belgium,Benelux - Luxembourg,Benelux - Netherlands",
        "regionName": null,
        "chzValue": "CHZ Sustainability Desk",
        "organizationalAlignmentValue": "Global",
        "requestForEmpowermentReasonValue": "Captive",
        "requestForEmpowermentStatusValue": "Pending",
        "creatorName": "Patti Fernandez",
        "underwriterName": "Megan Bowen",
        "underwriterGrantingEmpowermentName": null,
        "requestForEmpowermentCCName": null,
        "roleData": null,
        "rfeLogEmailLink": "https://dlzchui.azurewebsites.net/rfelogs?id=RFE01CA6EF08A3141499A6C8820A6B34E09",
        "totalCount": 0,
        "isArchived": false,
        "globalRFELogURL": null,
        "lastModifiorName": "Patti Fernandez",
        ...
        "isSharepointArchived": false,
        "importedBy": "",
        "importedDate": "2023-11-22T12:19:48.98",
        "conditionApplicableTo": null,
        "conditionApplicableToValue": null,
        "durationofApproval": "547V7D10-3334-064H-N831-H225743690RD",
        "durationofApprovalValue": "1",
        ...
        "referralReasonLevel1": null,
        "referralReasonLevel1Name": null,
        "referralReasonLevel2": "25509A5C-6EA9-4707-894E-AE898E38E775",
        "referralReasonLevel2Name": null,
        "referralReasonLevel3": null,
        "referralReasonActuarialLevel1": null,
        "referralReasonActuarialLevel2": null,
    ...
    {
        "rfeLogId": "RFE00C97043CA4542028D972BDA2CFB0D62",
        "accountName": "Test Indonesia",
        "entryNumber": "RFE_89533638",
        "organizationalAlignment": "A6B6A43F-574E-4E15-9EC2-49D080A16C45",
        "countryId": "COU000015",
        "regionId": "REG00001",
        "underwriter": "PattiF@2k0hmr.onmicrosoft.com",
        "chz": null,
        "lobId": "441599652036479",
        "requestForEmpowermentReason": "GEN71A82D5D-6D57-4849-A51F-D7F3C8B1536A",
        "rfeLogDetails": "<p>Test</p>",
        "underwriterGrantingEmpowerment": "MiriamG@2k0hmr.onmicrosoft.com",
        "requestForEmpowermentCC": null,
        "requestForEmpowermentStatus": "8BC958F0-677E-43AD-9886-D719082D21BD",
        "responseDate": null,
        "receptionInformationDate": null,
        ...
        "isSubmit": true,
        "createdById": "USR_7rUXlWDh",
        "createdDate": "2023-11-21T09:43:09.5",
        "modifiedById": "USR_7rUXlWDh",
        "modifiedDate": "2023-11-21T09:43:09.5",
        "lobName": "Accident and Health",
        "countryName": "Indonesia",
        "regionName": "APAC",
        "chzValue": null,
        "organizationalAlignmentValue": "Country",
        "requestForEmpowermentReasonValue": "Trade and Economic Sanctions",
        "requestForEmpowermentStatusValue": "Pending",
        "creatorName": "Patti Fernandez",
        "underwriterName": "Patti Fernandez",
        "underwriterGrantingEmpowermentName": null,
        "requestForEmpowermentCCName": null,
        "roleData": null,
        "rfeLogEmailLink": "https://dlzchui.azurewebsites.net/rfelogs?id=RFE00C97043CA4542028D972BDA2CFB0D62",
        "totalCount": 0,
        "isArchived": false,
        "globalRFELogURL": null,
        "lastModifiorName": "Patti Fernandez",
        ...
        "isSharepointArchived": false,
        "importedBy": "",
        "importedDate": "2023-11-21T09:43:09.5",
        "conditionApplicableTo": null,
        "conditionApplicableToValue": null,
        "durationofApproval": "547V7D10-3334-064H-N831-H225743690RD",
        "durationofApprovalValue": "1",
        ...
        "sublobName": null,
        "accountNumber": null,
        "linkedRFEEntryNumber": "RFE_82852923,RFE_77718094"
    },
    {
        "rfeLogId": "RFE01156066F248465BA11E34D0A40533C2",
        "accountName": "Test Australia",
        "entryNumber": "RFE_98986740",
        "organizationalAlignment": "A6B6A43F-574E-4E15-9EC2-49D080A16C45",
        "countryId": "COU000002",
        "regionId": "REG00001",
        "underwriter": "PattiF@2k0hmr.onmicrosoft.com",
        ...
        "lobId": "441599652036479",
        "requestForEmpowermentReason": "E234F097-4B52-4323-9B71-843D8CAFE04A",
        "rfeLogDetails": "<p>Demo Australia</p>",
        "underwriterGrantingEmpowerment": "MiriamG@2k0hmr.onmicrosoft.com",
        "requestForEmpowermentCC": null,
        "requestForEmpowermentStatus": "8BC958F0-677E-43AD-9886-D719082D21BD",
        "responseDate": null,
        ...
        "isSubmit": true,
        "createdById": "USR_7rUXlWDh",
        "createdDate": "2023-11-24T06:27:02.12",
        "modifiedById": "USR_7rUXlWDh",
        "modifiedDate": "2023-11-27T05:10:25.913",
        "lobName": "Accident and Health",
        ...
        "requestForEmpowermentCCName": null,
        "roleData": null,
        "rfeLogEmailLink": "https://dlzchui.azurewebsites.net/rfelogs?id=RFE01156066F248465BA11E34D0A40533C2",
        "totalCount": 0,
        "isArchived": false,
        "globalRFELogURL": null,
        "lastModifiorName": "Patti Fernandez",
        ...
        "isSharepointArchived": false,
        "importedBy": "",
        "importedDate": "2023-11-24T06:27:02.12",
        "conditionApplicableTo": null,
        "conditionApplicableToValue": null,
        "durationofApproval": "547V7D10-3334-064H-N831-H225743690RD",
        "durationofApprovalValue": "1",
  ...
  // useEffect(async()=>{
  //   // "formIntialState.rfeLogId"
  //   let response = await linkedLogLogs({rfeLogId: "RFE008ECE2096AF48BF843DF5441AD242AC" })
        ...
        tempelement = (
          <div className={`col-md-${obj.colspan}`}>
            <FrmSelect
              ...
              isAddButton={
                isGermany && showButtons && obj.isAddButton === true
                  ? true
                  : false
              }
